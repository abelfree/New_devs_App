...
async def calculate_monthly_revenue(
    ...
    check_in_date is stored in UTC, so the month boundaries must be built in
    the property's timezone and then converted to UTC. Otherwise a booking at
    00:30 on 1 March in Paris (23:30 on 28 Feb UTC) falls in the wrong month.
    """
